...
// Indian land categories for precision recommendations
const indianLandCategories = {
  "जलोढ़ मिट्टी": { regions: ["उत्तर प्रदेश", "बिहार", "पंजाब", "हरियाणा"], crops: ["गेहूं", "धान", "गन्ना"] },
  "काली मिट्टी": { regions: ["महाराष्ट्र", "मध्य प्रदेश", "गुजरात"], crops: ["कपास", "सोयाबीन", "ज्वार"] },
  "लाल मिट्टी": { regions: ["झारखंड", "ओडिशा", "छत्तीसगढ़"], crops: ["धान", "मक्का", "मूंगफली"] },
  "पर्वतीय मिट्टी": { regions: ["हिमाचल", "उत्तराखंड", "जम्मू-कश्मीर"], crops: ["सेब", "आलू", "अदरक"] },
  "मरुस्थलीय मिट्टी": { regions: ["राजस्थान", "गुजरात कच्छ"], crops: ["बाजरा", "मूंग", "ग्वार"] },
  "लवणीय मिट्टी": { regions: ["गुजरात तटीय", "राजस्थान पश्चिम"], crops: ["खजूर", "नारियल"] }
};
